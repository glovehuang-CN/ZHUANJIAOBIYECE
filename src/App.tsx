...
export default function App() {
  ...
  useEffect(() => {
    // We remove the global preventDefault to allow system long-press menu to function naturally
    // Protection is now mainly handled via CSS classes.
  }, []);
  ...
  return (
    <div className="flex flex-col h-[100dvh] w-full max-w-[430px] mx-auto bg-white overflow-hidden relative shadow-2xl pb-[env(safe-area-inset-bottom)]">
      ...
      <AnimatePresence>
        {showSplash && (
          <motion.div
            ...
            className="fixed inset-0 z-[400] bg-white w-full max-w-[430px] mx-auto overflow-hidden pointer-events-auto protected-content"
          >
            <img 
      ...
      {/* Header */}
      <header className="bg-primary text-white px-4 pt-[calc(1rem+env(safe-area-inset-top))] pb-4 flex justify-between items-center shrink-0 shadow-lg z-40 protected-content">
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto no-scrollbar pb-20 protected-content">
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-white border-t border-slate-100 flex justify-around items-center p-2 pb-[calc(8px+env(safe-area-inset-bottom))] z-40 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] protected-content">
        {[
