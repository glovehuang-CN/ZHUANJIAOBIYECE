          ...
          {activeTab === 'home' && (
            ...
            >
              ...
              <div className="relative h-48 rounded-2xl overflow-hidden shadow-xl">
                <img src="https://zhuanjiao-jiniance.oss-cn-shenzhen.aliyuncs.com/%E8%BD%AC%E8%A7%92%E6%AF%95%E4%B8%9A%E5%86%8Capp-%E9%A6%96%E9%A1%B501.webp" className="w-full h-full object-cover" alt="Hero" referrerPolicy="no-referrer" />
              ...
              <div className="flex-1 overflow-y-auto p-4 bg-slate-100">
                <div ref={compareExportRef} className="bg-white p-6 rounded-xl shadow-sm space-y-6">
                  <div className="flex items-center gap-3 border-b pb-4">
                    <img 
                      src="https://zhuanjiao-jiniance.oss-cn-shenzhen.aliyuncs.com/%E8%BD%AC%E8%A7%92%E8%93%9D%E8%89%B2%E9%80%8F%E6%98%8E%E5%BA%95LOGO.png" 
                      className="h-8 w-auto object-contain" 
                      alt="Logo" 
                      referrerPolicy="no-referrer"
                    />
                  ...
                  <div className="pt-4 flex justify-between items-end border-t">
                    <div className="space-y-1">
                      ...
                      <div className="w-12 h-12 bg-white rounded overflow-hidden flex items-center justify-center shadow-sm">
                        <img 
                          src="https://zhuanjiao-jiniance.oss-cn-shenzhen.aliyuncs.com/%E5%AE%A2%E6%9C%8D%E4%BA%8C%E7%BB%B4%E7%A0%81.webp" 
