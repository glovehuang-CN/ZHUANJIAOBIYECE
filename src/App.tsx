...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-[100dvh] w-full max-w-md mx-auto bg-white overflow-hidden relative shadow-2xl pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
      ...
      {/* Header */}
      <header className="bg-primary text-white p-4 flex justify-between items-center shrink-0 shadow-lg">
        <div className="flex items-center gap-2">
          <img 
            src="https://github.com/glovehuang-CN/ZHUANJIAO-BIYECE/blob/main/%E8%BD%AC%E8%A7%92%E7%99%BD%E8%89%B2%E9%80%8F%E6%98%8E%E5%BA%95LOGO.png?raw=true" 
          ...
          {activeTab === 'home' && (
            ...
            >
              ...
              <div className="relative h-48 rounded-2xl overflow-hidden shadow-xl">
                <img src="https://github.com/glovehuang-CN/ZHUANJIAO-BIYECE/blob/main/%E8%BD%AC%E8%A7%92%E6%AF%95%E4%B8%9A%E5%86%8Capp-%E9%A6%96%E9%A1%B501.jpg?raw=true" className="w-full h-full object-cover" alt="Hero" referrerPolicy="no-referrer" />
              ...
              <section className="space-y-3">
                ...
                <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2">
                  {BRAND_DATA.envPhotos.map((photo, idx) => (
                    <img key={idx} src={photo} className="h-32 w-48 object-cover rounded-lg shrink-0 shadow-md" alt="Env" referrerPolicy="no-referrer" />
                  ))}
                </div>
              </section>
            </motion.div>
                        ...
                        {compareList.map(p => (
                          <th key={p.id} className="p-3 text-center border-b min-w-[100px]">
                            <div className="relative">
                              ...
                              <img src={p.image} className="w-12 h-16 object-cover mx-auto rounded shadow-sm mb-2" alt={p.name} referrerPolicy="no-referrer" />
                  ...
                  <div className="flex flex-col gap-4">
                    {sample.images.map((img, idx) => (
                      <div key={idx} className="overflow-hidden shadow-lg">
                        <img src={img} className="w-full h-auto object-cover" alt={sample.title} referrerPolicy="no-referrer" />
                      </div>
                    ))}
                  </div>
                </div>
          ...
          >
            <div className="flex-1 overflow-y-auto no-scrollbar bg-white rounded-t-3xl mt-12 relative pb-[env(safe-area-inset-bottom)]">
              ...
              <div className="space-y-0">
                <img src={selectedProduct.image} className="w-full aspect-[3/4] object-cover" alt={selectedProduct.name} referrerPolicy="no-referrer" />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="pt-8 pb-4 flex justify-center">
                    <img 
                      src="https://github.com/glovehuang-CN/ZHUANJIAO-BIYECE/blob/main/%E6%AF%95%E4%B8%9A%E7%85%A7-%E9%80%89%E8%BD%AC%E8%A7%92sloga.png?raw=true" 
              ...
              <div className="flex-1 overflow-y-auto p-4 bg-slate-100">
                <div ref={compareExportRef} className="bg-white p-6 rounded-xl shadow-sm space-y-6">
                  <div className="flex items-center gap-3 border-b pb-4">
                    <img 
                      src="https://github.com/glovehuang-CN/ZHUANJIAO-BIYECE/blob/main/%E8%BD%AC%E8%A7%92%E8%93%9D%E8%89%B2%E9%80%8F%E6%98%8E%E5%BA%95LOGO.png?raw=true" 
                      className="h-8 w-auto object-contain" 
                      alt="Logo" 
                      referrerPolicy="no-referrer"
                    />
                      ...
                      <tr className="bg-slate-50">
                        ...
                        {compareList.map(p => (
                          <th key={p.id} className="p-2 text-center border">
                            <img src={p.image} className="w-12 h-16 object-cover mx-auto rounded shadow-sm mb-1" alt={p.name} referrerPolicy="no-referrer" />
                  ...
                  <div className="pt-4 flex justify-between items-end border-t">
                    <div className="space-y-1">
                      ...
                      <div className="w-12 h-12 bg-white rounded overflow-hidden flex items-center justify-center shadow-sm">
                        <img 
                          src="https://github.com/glovehuang-CN/ZHUANJIAO-BIYECE/blob/main/%E5%AE%A2%E6%9C%8D%E4%BA%8C%E7%BB%B4%E7%A0%81.jpeg?raw=true" 
